    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <span class="navbar-text">
                <a class="nav-link active button" aria-current="page" href="?page=register">Criar sua conta</a>
            </span>

            <span class="navbar-text">
                <a class="nav-link active" aria-current="page" href="?page=login">Entre</a>
            </span>
...
<div class="page">
    <div class="centerdiv">
                    ...
                    <div class="accordion" id="accordionFlushExample">
                        <div class="accordion-item">
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne"
                                data-bs-parent="#accordionExample" aria-expanded="false">
        ...
        <div class="produtos">
            <div data-aos="fade-left" class="shadow-sm border row produto">
                <img class="produto-imagem" src="res/teste.jpg">
                <div class="descricao">
                </div>
            </div>
            <div data-aos="fade-left" class="shadow-sm border row produto">
                <img class="produto-imagem" src="res/moto.jpg">
                <div class="descricao">
                </div>
            </div>
            <div data-aos="fade-left" class="shadow-sm border row produto">
                <img class="produto-imagem" src="res/celular2.png">
                <div class="descricao">
                </div>
            </div>
            <div data-aos="fade-left" class="shadow-sm border row produto">
                <img class="produto-imagem" src="res/notebook.png">
                <div class="descricaoProduto">
                    <span class=" tituloProduto">
                        Notebook Lenovo V14 (14" Intel)
                    </span>
